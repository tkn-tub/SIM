function [observation, LoggedSignals] = ...
...
LoggedSignals.n_psi_x_est=n_psi_x_max;
LoggedSignals.n_psi_y_est=n_psi_y_max;

t_psi_x_max = EnvPars.t_x(t_psi);
t_psi_y_max = EnvPars.t_y(t_psi);

LoggedSignals.t_psi_x_max = t_psi_x_max;
LoggedSignals.t_psi_y_max = t_psi_y_max;
