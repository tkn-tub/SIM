...
try
    ...
    path_enhanced = fullfile('..', 'Dataset', 'dqn_agent_navigation_144_neurons_norelu.mat');
...
hRaw = plot(epIdx, epReward, '.', 'Color', rawColor, 'MarkerSize', 8); 
hold on;
...
hAvg = plot(epIdx, epAvgReward, 'Color', mainColor, 'LineWidth', 2.5);
% --- Aesthetics & Formatting ---
grid on;
set(gca, 'GridLineStyle', ':', 'GridAlpha', 0.6, 'Layer', 'top');
set(gca, 'Box', 'off', 'TickDir', 'out', 'LineWidth', 1.2);
set(gca, 'FontName', 'Helvetica', 'FontSize', 12); % Fallback if 'font' variable isn't defined
xlabel('Episode', 'Interpreter', 'latex', 'FontSize', 14);
ylabel('Reward', 'Interpreter', 'latex', 'FontSize', 14);
