...
sim2_layer3  = simPhaseLayerCST(M, F_amp, 'sim2_M2');   % second learnable M-layer

% Layer 4 (the 9-port output) is confirmed to be the identity: Theta3=0,
...
save_path = fullfile('..', 'Dataset', 'dqn_agent_navigation_550_neurons_CST.mat');
