...
[obs0, logged0] = resetFunction_nav_CST_Hybrid(EnvPars); 
...
env = rlFunctionEnv(ObsInfo, ActInfo, ...
      @(a,ls) stepFunction_nav_CST_Hybrid(a, ls, EnvPars), ...
      @()     resetFunction_nav_CST_Hybrid(EnvPars));
...
save_path = fullfile(save_dir, sprintf( ...
    'dqn_agent_SIM2_BeamScanMAC_CST_1_layer_Nx_%d_Mx_%d_Hybrid.mat', EnvPars.N_x, M_x));
