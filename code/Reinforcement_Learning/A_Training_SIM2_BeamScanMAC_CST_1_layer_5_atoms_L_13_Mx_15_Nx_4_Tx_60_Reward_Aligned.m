...
EnvPars.MaxEpisodes = EnvPars.N_cal * 500;
...
save_path = fullfile(save_dir, sprintf( ...
    'dqn_agent_SIM2_BeamScanMAC_CST_1_layer_%d_atoms_L_%d_Nx_%d_Mx_%d_Tx_%d_Aligned.mat', M_x, L, EnvPars.N_x, EnvPars.M_x, EnvPars.T_x));
