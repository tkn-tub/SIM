...
maxIter = 2000
zeta_fixed = 0.993 %0.988;   % same value established from the ablation study; adjust if needed
h = 1e-5;              % finite-difference step (radians)
checkpoint_every = 25;
checkpoint_path = 'SIM_training_CST_checkpoint_zeta_0_993.mat';
...
%% ----------------- Save final result -----------------
path = fullfile('..', 'Dataset', 'SIM_training_CST_zeta_0_993_Nx_8.mat');
save(path, 'xi', 'Upsilon', 'G', 'beta', 'loss_hist', 'beta_hist', 'gap_frac_hist', ...
     'zeta_fixed', 'maxIter', 'eta0', 'seed', 'fc', '-v7.3');
