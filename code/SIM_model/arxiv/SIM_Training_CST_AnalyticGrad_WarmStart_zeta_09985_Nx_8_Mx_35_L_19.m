...
checkpoint_every = 25;
checkpoint_path = 'SIM_training_CST_analytic_zeta_0_9985_Mx_35_L_19.mat';
...
if isfile(checkpoint_path)
    ...
    warm_start_file = fullfile('..', 'Dataset', 'SIM_training_CST_zeta_0_9985_Nx_8_Mx_35_L_19.mat');
...
%% ----------------- Save final result -----------------
path = fullfile('..', 'Dataset', 'SIM_training_CST_analytic_zeta_09985_Mx_35_L_19.mat');
save(path, 'xi', 'Upsilon', 'G', 'beta', 'loss_hist', 'beta_hist', 'gap_frac_hist', ...
