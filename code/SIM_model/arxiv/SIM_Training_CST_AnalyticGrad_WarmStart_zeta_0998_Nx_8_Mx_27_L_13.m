...
maxIter = 4000
zeta_fixed = 0.998 %0.988;   % same value established from the ablation study; adjust if needed
M_x=27
M_y=M_x;
M=M_x*M_y;
L=13
...
checkpoint_every = 25;
checkpoint_path = 'SIM_training_CST_analytic_zeta_0_998_Mx_27_L_13.mat';
...
if isfile(checkpoint_path)
    ...
    % warm_start_file = fullfile('..', 'Dataset', 'SIM_training_CST_zeta_0_995_Nx_8_Mx_17_L_13.mat');
    % 
...
%% ----------------- Save final result -----------------
path = fullfile('..', 'Dataset', 'SIM_training_CST_analytic_zeta_0_998_Mx_27_L13.mat');
save(path, 'xi', 'Upsilon', 'G', 'beta', 'loss_hist', 'beta_hist', 'gap_frac_hist', ...
