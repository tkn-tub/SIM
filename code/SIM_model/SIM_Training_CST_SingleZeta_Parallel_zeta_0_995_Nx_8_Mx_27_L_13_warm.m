...
checkpoint_every = 25;
checkpoint_path = 'SIM_training_CST_checkpoint_zeta_0_995_Nx_8_Mx_27_L_13_warm.mat';
...
%% ----------------- Save final result -----------------
path = fullfile('..', 'Dataset', 'SIM_training_CST_zeta_0_995_Nx_8_Mx_27_L_13_warm.mat');
save(path, 'xi', 'Upsilon', 'G', 'beta', 'loss_hist', 'beta_hist', 'gap_frac_hist', ...
     'zeta_fixed', 'maxIter', 'eta0', 'seed', 'fc', '-v7.3');
